...
const ManageChefs = () => {
    ...
    const initialChefs = [
        { id: 1, name: 'Gordon Ramsay', email: 'gordon.ramsay@example.com', contact: '123-456-7890', address: '123 Culinary St', password: 'hellskitchen' },
        { id: 2, name: 'Jamie Oliver', email: 'jamie.oliver@example.com', contact: '987-654-3210', address: '456 Food Ave', password: 'foodrevolution' },
    ...
    const handleEditChef = (id) => {
        ...
        if (chefToEdit) {
            ...
            setChefContact(chefToEdit.contact);
    ...
    const handleSubmit = (e) => {
        ...
        if (editMode && editChefId !== null) {
            ...
            const updatedChefs = chefs.map(chef =>
                chef.id === editChefId ? { ...chef, name: chefName, email: chefEmail, contact: chefContact, address: chefAddress, password: chefPassword } : chef
            );
                ...
                <form onSubmit={handleSubmit} className="mb-4">
                    <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 mb-4">
                        ...
                        <input
                            ...
                            value={chefContact}
                            onChange={(e) => setChefContact(e.target.value)}
                            className="border rounded py-2 px-3"
                            required
                        />
                        <input
                        ...
                        <tbody>
                            {chefs.map(chef => (
                                <tr key={chef.id} className="border-b border-gray-200">
                                    ...
                                    <td className="py-2 px-4">{chef.contact}</td>
